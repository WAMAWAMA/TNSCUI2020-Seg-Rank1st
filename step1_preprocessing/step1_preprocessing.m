...
%% 路径设置 set path
img_dir ='C:\Users\wamawama\Desktop\甲状腺结节外部数据集\@DDTI\1_or_data\image';
mask_dir = 'C:\Users\wamawama\Desktop\甲状腺结节外部数据集\@DDTI\1_or_data\mask';
csv_file = 'C:\Users\wamawama\Desktop\甲状腺结节外部数据集\@DDTI\1_or_data\category.csv';
save_dir ='C:\Users\wamawama\Desktop\甲状腺结节外部数据集\@DDTI\2_preprocessed_data';
